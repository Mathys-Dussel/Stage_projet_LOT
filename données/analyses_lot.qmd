...
plot_ordination(ps, nmds_bray, color = "organ", shape = "project") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis")

plot_ordination(ps, nmds_bray, color = "project", shape = "organ") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis")

plot_ordination(ps, nmds_bray, color = "plant_family", shape = "project") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis")


plot_ordination(ps, nmds_bray, color = "plant_genus", shape = "project") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis")
...
```
visualisation de la diversité bêta avec PCoA
```{r}

pcoa_bray <- ordinate(ps, method = "PCoA", distance = "bray")

plot_ordination(ps, pcoa_bray, color = "organ", shape = "position") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "PCoA - Bray-Curtis")  

plot_ordination(ps, pcoa_bray, color = "project", shape = "organ") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "PCoA - Bray-Curtis")  
...
table(metadata$project, metadata$plant_family)
table(metadata$project, metadata$plant_genus)
table(metadata$project, metadata$plant_species)

ggplot(metadata, aes(x = project, fill = plant_family)) +
    geom_bar(position = "fill", color = "black", alpha = 0.8) +
    theme_bw() +
    labs(title = "Composition en familles de plantes selon le projet LOT",
             x = "Projet LOT",
             y = "Abondance relative (échantillons)",
             fill = "Famille de plante")

ggplot(metadata, aes(x = project, fill = plant_genus)) +
    geom_bar(position = "fill", color = "black", alpha = 0.8) +
    theme_bw() +
    labs(title = "Composition en genres de plantes selon le projet LOT",
             x = "Projet LOT",
             y = "Abondance relative (échantillons)",
             fill = "Genre de plante")

ggplot(metadata, aes(x = project, fill = plant_species)) +
    geom_bar(position = "fill", color = "black", alpha = 0.8) +
    theme_bw() +
    labs(title = "Composition en espèces de plantes selon le projet LOT",
             x = "Projet LOT",
             y = "Abondance relative",
             fill = "Espèce de plante")


adonis2(bray_dist ~ plant_family, data = metadata, permutations = 99)


perm2= adonis2(bray_dist ~ plant_genus, data = metadata, permutations = 99)


perm3= adonis2(bray_dist ~ plant_species, data = metadata, permutations = 99)

perm4= adonis2(bray_dist ~ plant_family + project, data = metadata, permutations = 99)


perm4=adonis2(bray_dist ~ project * organ * position, data = metadata, permutations = 99)
