...
familles_a_enlever <- c("Famille1", "Famille2") 
...
pcoa_bray <- ordinate(ps_hellinger, method = "PCoA", distance = "bray")
...
plot_ordination(ps_hellinger, nmds_bray_K3, color = "organ", shape = "position") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis (Hellinger)")

plot_ordination(ps_hellinger, nmds_bray_K3, color = "organ", shape = "project") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis")

plot_ordination(ps_hellinger, nmds_bray_K3, color = "project") +
    geom_point(aes(shape = organ), size = 3, alpha = 0.8) +
    theme_bw() +
    stat_ellipse(aes(group = project)) +
    labs(title = "NMDS - Bray-Curtis")

plot_ordination(ps_hellinger, nmds_bray_K3, color = "plant_family", shape = "project") +
    geom_point(size = 3, alpha = 0.8) +
    theme_bw() +
    labs(title = "NMDS - Bray-Curtis")
...
adonis2(
  bray_dist ~ project * organ * plant_family * position, 
...
adonis2(
  bray_dist ~ project  * plant_family, 
  data = metadata_global, 
  permutations = 99,
  by = "terms"
)
...
adonis2(
  bray_dist ~ position  * plant_family, 
  data = metadata_global, 
  permutations = 99,
  by = "terms"
)
...
nmds_lot1 <- ordinate(ps_lot1, method = "NMDS", distance = "bray", k=3)
...
adonis2(bray_dist_lot1 ~ position*plant_family*organ, data = meta_lot1, permutations = 99, by = "terms")

adonis2(bray_dist_lot1 ~ plant_family, data = meta_lot1, permutations = 99, by = "terms")

adonis2(bray_dist_lot1 ~ position*plant_family, data = meta_lot1, permutations = 999, by= "terms")
