...
# Aggrégation au niveau de la classe taxonomique
ps_class <- tax_glom(ps_rel, taxrank = "gbr268_Class", NArm = FALSE)

# Filtrer pour ne garder que les classes avec une abondance relative moyenne > 2%
...
# Créer une variable combinée pour organe et position
...
ggplot(df_class, aes(x = Sample, y = Abundance, fill = gbr268_Class)) +
    ...
    labs(title = "Abondances relatives des principales classes fongiques (> 2%) par zone",
         x = "Échantillons (ordonnés par la lumière reçue)",
         y = "Abondance relative",
         fill = "Classe fongique") +
    theme(legend.position = "bottom",
          axis.text.x = element_blank(), # Masquer les noms d'échantillons pour plus de clarté
