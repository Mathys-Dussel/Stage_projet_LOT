...
\begin{Méthodologie}{}
    \textbf{Création d'un UpSet plot et d'un diagramme en corde pour visualiser les OTUs partagés entre les différentes modalités} 
...
\begin{attention}
Il faut aussi faire des ordinations entre les différents LOTs pour voir s'il y a des regroupements en fonction des différents organes ou positions dans chaques projets.
Pour le diagramme en corde, pas seulement entre otu mais entre les otu et les organes.
\end{attention}



\section{Mercredi 11 Mars}

\begin{objectifs}
    \begin{itemize}
        \item Faire les NMDS pour les différents LOTs séparément.
        \item Faire des diagrammes en corde entre les OTUs et les organes pour voir s'il y a des associations particulières entre certains OTUs et certains organes.
        \item Diagramme de Venn pour visualiser les OTUs partagés entre les différents organes et Projets.
        \item Determiner le core microbiota de notre jeu de données, c'est à dire les OTUs qui sont présents dans au moins 10\% des échantillons avec une abondance relative d'au moins 0.1\%.
    \end{itemize}
\end{objectifs}
